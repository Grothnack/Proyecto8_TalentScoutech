...
Explicación del ataque	El ataque consiste en repetir… |	peticiones de login a la página mediante la herramienta hydra |
...
¿Cómo podemos hacer que sea segura esta entrada?	Utilizar consultas preparadas:
...
Utilizar funciones de seguridad específicas de la base de datos, como ‘SQLite3::scapeString()’ en conjunto con las consultas preparadas.
